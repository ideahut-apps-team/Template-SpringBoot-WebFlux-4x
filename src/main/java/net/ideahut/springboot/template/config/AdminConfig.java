...
class AdminConfig {
	...
	AdminHandler adminHandler(
		...
		@Qualifier(AppConstant.Bean.Redis.PRIMARY) 
	 ...
	 * ADMIN CREDENTIAL
	 */
	@Bean(name = AppConstant.Bean.Credential.ADMIN)
	 ...
	 * ADMIN SECURITY
	 */
	@Bean(name = AppConstant.Bean.Security.ADMIN)
	WebFluxSecurity adminSecurity(
		AppProperties appProperties,
		DataMapper dataMapper,
		AdminHandler adminHandler,
		@Qualifier(AppConstant.Bean.Credential.ADMIN)
