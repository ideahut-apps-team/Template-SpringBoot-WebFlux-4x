# Template SpringBoot WebFlux 4x&nbsp;&nbsp;<img height="32" src="https://github.com/ideahut-apps-team/Ideahut-Spring-Boot/blob/main/docs/assets/ideahut.png?raw=true" alt="">&nbsp;<img height="32" src="https://github.com/ideahut-apps-team/Ideahut-Spring-Boot/blob/main/docs/assets/spring-boot.png?raw=true" alt="">
...
* Masuk ke directory project.
    ```shell
    cd ./Template-SpringBoot-WebFlux-4x
    ```
...
* Mengumpulkan metadata untuk __Native Image__.
    ...
    -jar target/Template-SpringBoot-WebFlux-4x-1.0.0.jar
    ```
* Menggabungkan _serialization_ ke metadata.
    ```shell
    $JAVA_HOME/bin/java -cp target/Template-SpringBoot-WebFlux-4x-1.0.0.jar \
